...
(function() {
    ...
    let allMenus = [];
        ...
        const UPGRADE_DEFS = {
            ...
            ohNo: { basePrice: null, multiplier: null, name: 'Oh No', color: '#93f', tooltip: 'What have you done', disabled: true },
        ...
        function toggleMenu(color) {
            ...
            if (openMenu) {
                ...
                oldMenu.style.zIndex = 2147483644;
                setTimeout(() => {
                    ...
                    function showTooltip(e) {
                        if (!tooltip) {
                            ...
                            Object.assign(tooltip.style, {
                                ...
                                font: "600 14px 'Segoe UI', sans-serif", pointerEvents: 'none', zIndex: 2147483647, boxShadow: '0 2px 8px #0007', whiteSpace: thisDef.tooltip.includes('\n') ? 'pre-wrap' : 'nowrap', opacity: 0.97,
                ...
                function showBETooltip(e) {
                    if (!beTooltip) {
                        ...
                        Object.assign(beTooltip.style, {
                            position: 'fixed', background: '#222', color: '#fff', border: '1.5px solid #f90', borderRadius: '7px', padding: '6px 13px', font: "600 14px 'Segoe UI', sans-serif", pointerEvents: 'none', zIndex: 2147483647, boxShadow: '0 2px 8px #0007', whiteSpace: 'pre-wrap', opacity: 0.97, left: '0', top: '0', transition: 'none'
                        });
