(function() {
  ...
  function getUpgradeIconPathById(upgradeId){
    if (/^mbt\d+$/.test(upgradeId)) return 'addons/clicker/icons/meme.png';
    if (/^met\d+$/.test(upgradeId)) return 'addons/clicker/icons/extraup.png';
    if (upgradeId === 'amntt1') return 'addons/clicker/icons/offline.png';
    if (/^amntt\d+$/.test(upgradeId)) return 'addons/clicker/icons/amount.png';
    if (/^timet\d+$/.test(upgradeId)) return 'addons/clicker/icons/time.png';
    if (upgradeId === 'mut1') return 'addons/clicker/icons/lolcat.png';
    if (upgradeId === 'mut2') return 'addons/clicker/icons/alpha.png';
    if (upgradeId === 'mut3') return 'addons/clicker/icons/facebook.png';
    if (upgradeId === 'mut4') return 'addons/clicker/icons/tragedy.png';
    if (upgradeId === 'mut5') return 'addons/clicker/icons/vidya.png';
    if (upgradeId === 'mut6') return 'addons/clicker/icons/foreign.png';
    if (upgradeId === 'mut7') return 'addons/clicker/icons/fj.png';
    if (/^lct\d+$/.test(upgradeId)) return 'addons/clicker/icons/lolcat.png';
    if (/^gat\d+$/.test(upgradeId)) return 'addons/clicker/icons/alpha.png';
    if (/^fbt\d+$/.test(upgradeId)) return 'addons/clicker/icons/facebook.png';
    if (/^tgt\d+$/.test(upgradeId)) return 'addons/clicker/icons/tragedy.png';
    if (/^vgt\d+$/.test(upgradeId)) return 'addons/clicker/icons/vidya.png';
    if (/^fgt\d+$/.test(upgradeId)) return 'addons/clicker/icons/foreign.png';
    if (/^fjt\d+$/.test(upgradeId)) return 'addons/clicker/icons/fj.png';
    if (/^spt\d+$/.test(upgradeId)) return 'addons/clicker/icons/special.png';
    if (/^slott\d+$/.test(upgradeId)) return 'addons/clicker/icons/spin.png';
    
    if (/^clickt\d+$/.test(upgradeId)) return 'addons/clicker/icons/upgrades/clickup.png';
    const parsed = extractProducerIdFromUpgradeId(upgradeId);
    if (parsed && parsed.producerId) return `addons/clicker/icons/upgrades/${parsed.producerId}up.png`;
    
    return 'addons/clicker/icons/upgrades/clickup.png';
  }
  ...
  function getProductionIconPathByProducerId(producerId){
    const baseName = (getProducerName(producerId) || producerId || '')
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, '_');
    return `addons/clicker/icons/production/${baseName}.png`;
  }
    ...
    card.addEventListener('mouseenter', () => {
      try {
        ...
        window.fjfeRcInfo.show({
          ...
          name: upgrade.name,
          cost: formattedPrice,
          costIcon: (upgrade && upgrade.currency === 'alts') ? 'addons/clicker/icons/alts.png' : undefined,
