...
(function() {
    ...
    (function setupAudio(){
        ...
        const sources = {
            menu_open: 'addons/clicker/icons/menu_open.mp3',
            menu_close: 'addons/clicker/icons/menu_close.mp3',
            click: 'addons/clicker/icons/click.mp3',
            upgrade: 'addons/clicker/icons/upgrade.mp3',
            deny: 'addons/clicker/icons/deny.mp3',
            prestige: 'addons/clicker/icons/prestige.mp3',
            production: 'addons/clicker/icons/production.mp3',
        };
    ...
    Object.assign(btnRed.style, btnStyleBottom, {
        ...
        const makeArrowIcon = () => {
            ...
            const src = chrome.runtime && chrome.runtime.getURL ? chrome.runtime.getURL('addons/clicker/icons/down_icon.png') : 'addons/clicker/icons/down_icon.png';
            img.src = src;
    ...
    win.appendChild(bottomRow);
        ...
        iconImg.src = chrome.runtime.getURL ? chrome.runtime.getURL('addons/clicker/icons/repost.png') : 'addons/clicker/icons/repost.png';
        iconImg.onerror = () => {
    ...
    thumbImg.src = chrome.runtime.getURL ? chrome.runtime.getURL('addons/clicker/icons/thumb.png') : 'addons/clicker/icons/thumb.png';
