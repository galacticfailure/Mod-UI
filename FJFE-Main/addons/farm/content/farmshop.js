(() => {
	...
	const iconFor=(file)=>`addons/farm/icons/objects/${file}`;
	...
	const buildUI=()=>{
		...
		coinImg.src=resolve('addons/farm/icons/coin.png'); coinImg.onerror=function(){ this.src=resolve('icons/error.png'); };
	...
	const placeObject = (tileElement, tileIndex, objectName, objectCost, extraData) => {
		...
		const desiredIconKey = isCompostBin
			...
			: isRainBarrel
				...
				: objectName;
		objectImg.src = resolve(`addons/farm/icons/objects/${desiredIconKey}.png`);
