(() => {
  ...
  const TOOL_ICONS = [
    ...
    { key: 'hoebasic',   icon: 'addons/farm/icons/tools/hoebasic.png' },
    { key: 'wcbasic',    icon: 'addons/farm/icons/tools/wcbasic.png' },
    { key: 'weedbasic',  icon: 'addons/farm/icons/tools/weedbasic.png' },
    { key: 'hvstbasic',  icon: 'addons/farm/icons/tools/hvstbasic.png' },
    
    { key: 'hoebetter',  icon: 'addons/farm/icons/tools/hoebetter.png' },
    { key: 'wcbetter',   icon: 'addons/farm/icons/tools/wcbetter.png' },
    { key: 'weedbetter', icon: 'addons/farm/icons/tools/weedbetter.png' },
    { key: 'hvstbetter', icon: 'addons/farm/icons/tools/hvstbetter.png' },
    
    { key: 'hoebest',    icon: 'addons/farm/icons/tools/hoebest.png' },
    { key: 'wcbest',     icon: 'addons/farm/icons/tools/wcbest.png' },
    { key: 'weedbest',   icon: 'addons/farm/icons/tools/weedbest.png' },
    { key: 'hvstbest',   icon: 'addons/farm/icons/tools/hvstbest.png' },
    
    { key: 'glove',      icon: 'addons/farm/icons/tools/glove.png' },
    { key: 'bulldoze',   icon: 'addons/farm/icons/tools/bulldoze.png' },
  ];
  ...
  if (getSeedsModule()?.isTreeSeed?.(plantData.seedName)) return;
      ...
      if (needsWatering) {
        ...
        wateringImg.src = resolve('addons/farm/icons/watering.png');
      ...
      if (needsWeeding) {
        ...
        weedingImg.src = resolve('addons/farm/icons/weeding.png');
            ...
            if (t) {
              ...
              if (growthInfo?.isGrown && growthInfo?.seedName) {
                try {
                  ...
                  const grownSrc = resolve(`addons/farm/icons/plants/${growthInfo.seedName}_grown.png`);
  ...
  const buildUI = (host) => {
    ...
    const makeBtn = (item, index) => {
      ...
      if (locked) {
        ...
        lockImg.src = resolveAssetUrl('addons/farm/icons/locked.png');
  ...
  Object.assign(buyBtn.style, { position:'absolute', top:'50%', left:'50%', transform:'translate(-50%, -50%)', display:'none', padding:'2px 6px', background:'#c33', color:'#fff', border:'1px solid #a22', borderRadius:'4px', fontWeight:'700', fontSize:'12px', cursor:'pointer', pointerEvents:'auto' });
        ...
        coin.alt=''; coin.decoding='async'; coin.loading='lazy'; coin.draggable=false; coin.src = resolveAssetUrl('addons/farm/icons/coin.png');
  ...
  const showSaleFloat = (tileElement, amount) => {
    try {
      ...
      coin.src = resolveAssetUrl ? resolveAssetUrl('addons/farm/icons/coin.png') : 'addons/farm/icons/coin.png';
