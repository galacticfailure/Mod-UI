  ...
  const init = () => {
    ...
    document.addEventListener('contextmenu', (e) => {
      if (selectedItem) {
        ...
        if (wasMovedObject) {
          selectItem({ key: 'glove', type: 'tool', icon: 'addons/farm/icons/tools/glove.png' }, null);
        }
      }
    });
        ...
        if (tileModule && tileModule.getTileTips) {
          ...
          if (tileInfo) {
            tooltipData = {
              ...
              ...(tileInfo.prc > 0 ? { cost: String(tileInfo.prc), costIcon: 'addons/farm/icons/coin.png' } : {}),
            };
          }
        }
        ...
        if (shopModule && shopModule.getObjectTips) {
          ...
          if (objectInfo) {
            tooltipData = {
              ...
              ...(objectInfo.prc > 0 ? { cost: String(objectInfo.prc), costIcon: 'addons/farm/icons/coin.png' } : {}),
            };
          }
        }
