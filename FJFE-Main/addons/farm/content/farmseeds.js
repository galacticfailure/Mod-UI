(() => {
	...
	const iconFor = (name) => `addons/farm/icons/plants/${toKey(name)}_seed.png`;
	...
	const parseTags = (value) => {
		...
		const box = document.createElement('div');
			...
			coinImg.src = resolveAssetUrl('addons/farm/icons/coin.png');
			...
			tiles.forEach((tile, tileIndex) => {
				...
				if (plantOverlay) {
					const newSrc = isFullyGrown
						? resolveAssetUrl(`addons/farm/icons/plants/${plantData.seedName}_grown.png`)
						: resolveAssetUrl(`addons/farm/icons/plants/${plantData.seedName}_growing.png`);
