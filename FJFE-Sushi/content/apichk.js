  ...
  const ensureFooterUI = () => {
    try {
      ...
      btn.addEventListener('mouseenter', () => {
        btn.style.boxShadow = '0 0 8px rgba(255, 140, 0, 0.75)';
        btn.style.background = 'linear-gradient(180deg, #ffd27a 0%, #ffa733 100%)';
      });
      btn.addEventListener('mouseleave', () => {
        btn.style.boxShadow = '';
        btn.style.background = 'linear-gradient(180deg, #ffb347 0%, #ff8c00 100%)';
